    ...
    return (
        <>
            <section className='container text-wrap text-center'>
                ...
                <h3 className='text-2xl md:text-3xl font-bold'>The leading road trip service in Telangana, Maharashtra, Karnataka, Tamil Nadu, and Goa</h3>

                <div className='services-container md:text-left flex flex-col md:flex-row gap-1 md:gap-8 mt-4 '>

                    <div className='my-3 max-w-lg mx-auto grow'>
                        <div className='svg-img text-blue-700'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10">
                                <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 0 0 0-1.5h-3.75V6Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <h4 className='text-md md:text-lg font-semibold'>Flexible cancellation up to 72h prior to your journey</h4>
                    ...
                    <div className='my-3 max-w-lg mx-auto grow'>
                        ...
                        <h4 className='text-md md:text-lg font-semibold'>One-way trips are available</h4>
                    ...
                    <div className='my-3 max-w-lg mx-auto grow'>
                        ...
                        <h4 className='text-md md:text-lg font-semibold'>RAC Breakdown Cover</h4>
                    ...
                    <div className='my-3 max-w-lg mx-auto grow'>
                        ...
                        <h4 className='text-md md:text-lg font-semibold'>Book now, pay later!</h4>
