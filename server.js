...
createServer({
    ...
    seeds(server) {
        server.create("car", { id: "1", name: "Compact Commuter", price: 6000,       description: "This fuel-efficient hatchback is perfect for navigating city streets and finding tight parking spots. Its spacious interior offers surprising cargo capacity for weekend getaways.", imageUrl: "https://images.pexels.com/photos/28123191/pexels-photo-28123191/free-photo-of-the-tesla-model-s-is-shown-in-this-image.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", type: "sedan", hostId:"96" })
        server.create("car", { id: "2", name: "Family Adventure", price: 8000,       description: "This versatile SUV offers ample seating for the whole family and plenty of cargo space for all your gear. Its all-wheel drive capability lets you confidently explore off-the-beaten-path adventures.",
            imageUrl: "https://images.pexels.com/photos/14038622/pexels-photo-14038622.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", type: "suv", hostId:"123" })
